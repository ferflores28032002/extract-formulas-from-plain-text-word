...
const ExtractedContent: React.FC<{ content: string }> = ({ content }) => (
  <div className="mt-6 p-4 bg-white border border-gray-300 rounded-lg shadow-lg max-h-[45rem] w-[90%] overflow-y-auto">
    ...
    <pre className="whitespace-pre-wrap text-gray-700">{content || 'Sube un archivo Word para extraer el contenido.'}</pre>
  </div>
);
...
const WordExtractor: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Extractor de Texto de Word</h1>
